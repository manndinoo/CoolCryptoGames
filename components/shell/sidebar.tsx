  ...
  return (
    ...
    >
                ...
                return (
                  <li key={item.href}>
                    ...
                    >
                      ...
                      <span
                        aria-hidden
                        className="ccg-side-marker absolute top-1/2 left-0 h-5 w-[3px] -translate-y-1/2 rounded-r-full bg-acid"
                      />
      ...
      <div className="shrink-0 border-t border-[var(--color-subtle-border)] p-3">
        <Link
          href="/games"
          className="ccg-side-cta flex h-11 items-center justify-center gap-2 rounded-[var(--radius-pill)] bg-acid px-4 font-display text-xs font-bold tracking-[var(--tracking-label)] text-carbon uppercase transition-transform duration-[var(--duration-fast)] hover:scale-[1.02] active:scale-[0.99]"
        >
